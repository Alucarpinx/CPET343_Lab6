...
# --------------------------------------------------------------------------
# STEP 1: Update the name of your project here
# --------------------------------------------------------------------------
...
set_global_assignment -name VHDL_FILE ../../src/lab7/clock_synchronizer.vhd
set_global_assignment -name VHDL_FILE ../../src/lab7/Hex2seven_seg.vhd
set_global_assignment -name VHDL_FILE ../../src/lab7/edge_detect.vhd
set_global_assignment -name VHDL_FILE ../../src/lab7/raminfr.vhd
set_global_assignment -name VHDL_FILE ../../src/lab7/common.vhd
set_global_assignment -name VHDL_FILE ../../src/lab7/alu.vhd
set_global_assignment -name VHDL_FILE ../../src/lab7/calculator.vhd
set_global_assignment -name VHDL_FILE ../../src/ROM/ROM.vhd
set_global_assignment -name VHDL_FILE ../../src/Instruction_decoder.vhd
set_global_assignment -name VHDL_FILE ../../src/delay_register.vhd
set_global_assignment -name VHDL_FILE ../../src/processor.vhd
...
# --------------------------------------------------------------------------
# STEP 3: Update the pin constraints here. Comment and uncomment as needed.
#         NOTE: only the most common pins are listed below.
# --------------------------------------------------------------------------
